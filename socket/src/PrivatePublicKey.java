...
public class PrivatePublicKey {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            privateKeyStore.load(privateKeyFile, "keystore".toCharArray());
            PrivateKey privateKey = (PrivateKey) privateKeyStore.getKey(
                    "veda_private", "keystore".toCharArray());
            ...
            publicKeyStore.load(publicKeyFile, "keystore".toCharArray());
            Certificate publicCertificate = publicKeyStore
                    .getCertificate("veda_public");
